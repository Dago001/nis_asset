...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p>Manage weapon calibre classifications</p>
        </div>
    ...
    <div class="content-card">
        <div class="section-title">
            <h2><i class="fas fa-list"></i> Weapon Calibres</h2>
        </div>
            ...
            <table class="asset-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo Security::escape($calibre['calibre_name']); ?></td>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <a href="<?php echo BASE_URL; ?>/weapons/calibres/delete/<?php echo $calibre['id']; ?>" 
...
<div class="modal" id="addCalibreModal" style="display: none;">
    <div class="modal-content">
        ...
        <form method="POST" action="<?php echo BASE_URL; ?>/weapons/calibres/store">
            <?php echo Security::csrfField(); ?>
            <div class="modal-body">
                <div class="form-group">
                    <label class="required">Calibre Name</label>
                    <input type="text" name="calibre_name" required maxlength="50" class="form-control" placeholder="e.g., 7.62x39mm">
                </div>
                <div class="form-group">
