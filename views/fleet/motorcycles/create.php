...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p>Enter motorcycle asset details</p>
        </div>
    ...
    <div class="form-section">
        <form method="POST" action="<?php echo BASE_URL; ?>/fleet/motorcycles/store" enctype="multipart/form-data" id="motorcycleForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="use_purpose" required class="form-control <?php echo isset($errors['use_purpose']) ? 'error' : ''; ?>">
                            ...
                            <option value="Reserved" <?php echo ($old['use_purpose'] ?? '') == 'Reserved' ? 'selected' : ''; ?>>Reserved</option>
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="motorcycle_type" id="motorcycle_type" required class="form-control <?php echo isset($errors['motorcycle_type']) ? 'error' : ''; ?>">
                            <option value="">Select Type</option>
                            <option value="Trail" <?php echo ($old['motorcycle_type'] ?? '') == 'Trail' ? 'selected' : ''; ?>>Trail</option>
                            <option value="Street" <?php echo ($old['motorcycle_type'] ?? '') == 'Street' ? 'selected' : ''; ?>>Street</option>
                            <option value="Sport" <?php echo ($old['motorcycle_type'] ?? '') == 'Sport' ? 'selected' : ''; ?>>Sport</option>
                            <option value="Cruiser" <?php echo ($old['motorcycle_type'] ?? '') == 'Cruiser' ? 'selected' : ''; ?>>Cruiser</option>
                            <option value="Scooter" <?php echo ($old['motorcycle_type'] ?? '') == 'Scooter' ? 'selected' : ''; ?>>Scooter</option>
                    ...
                    <div class="form-group" id="typeOtherWrapper" style="display: none;">
                        ...
                        <input type="text" name="motorcycle_type_other" id="motorcycle_type_other" class="form-control" 
                               value="<?php echo Security::escape($old['motorcycle_type_other'] ?? ''); ?>" placeholder="Enter motorcycle type">
                    </div>
                </div>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="chassis_number" value="<?php echo Security::escape($old['chassis_number'] ?? ''); ?>" 
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="current_mileage" value="<?php echo Security::escape($old['current_mileage'] ?? ''); ?>" 
            ...
            <div class="form-section-inner">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="current_location" value="<?php echo Security::escape($old['current_location'] ?? ''); ?>" 
                           class="form-control" placeholder="e.g., Main Garage, Zone A">
                </div>
                
                <div class="form-group">
                    <label>Assigned Officer/Unit</label>
                    <input type="text" name="assigned_officer_unit" value="<?php echo Security::escape($old['assigned_officer_unit'] ?? ''); ?>" 
                           class="form-control" placeholder="Officer or unit assigned">
                </div>
            </div>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="last_serviced_date" value="<?php echo Security::escape($old['last_serviced_date'] ?? ''); ?>" 
                               class="form-control" max="<?php echo date('Y-m-d'); ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>Next Service Due</label>
                        <input type="date" name="next_service_due" value="<?php echo Security::escape($old['next_service_due'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-group">
                    <textarea name="remarks" rows="3" class="form-control" 
                              placeholder="Any additional remarks about the motorcycle"><?php echo Security::escape($old['remarks'] ?? ''); ?></textarea>
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="button" class="btn btn-secondary" onclick="resetForm('motorcycleForm')">
                    <i class="fas fa-undo"></i> Reset Form
                </button>
                <a href="<?php echo BASE_URL; ?>/fleet/motorcycles" class="btn btn-outline">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeSelect) {
        ...
        <?php if (($old['motorcycle_type'] ?? '') === 'Other'): ?>
