...
<div class="container-fluid">
    ...
    <div class="form-section">
        <form method="POST" action="<?php echo BASE_URL; ?>/fleet/aircraft/store" enctype="multipart/form-data" id="aircraftForm">
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="use_purpose" required class="form-control <?php echo isset($errors['use_purpose']) ? 'error' : ''; ?>">
                            ...
                            <option value="Training" <?php echo ($old['use_purpose'] ?? '') == 'Training' ? 'selected' : ''; ?>>Training</option>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="aircraft_type" id="aircraft_type" required class="form-control <?php echo isset($errors['aircraft_type']) ? 'error' : ''; ?>">
                            ...
                            <option value="Helicopter" <?php echo ($old['aircraft_type'] ?? '') == 'Helicopter' ? 'selected' : ''; ?>>Helicopter</option>
                            <option value="Fixed Wing" <?php echo ($old['aircraft_type'] ?? '') == 'Fixed Wing' ? 'selected' : ''; ?>>Fixed Wing</option>
                            <option value="Jet" <?php echo ($old['aircraft_type'] ?? '') == 'Jet' ? 'selected' : ''; ?>>Jet</option>
                            <option value="Propeller" <?php echo ($old['aircraft_type'] ?? '') == 'Propeller' ? 'selected' : ''; ?>>Propeller</option>
                    ...
                    <div class="form-group" id="typeOtherWrapper" style="display: none;">
                        ...
                        <input type="text" name="aircraft_type_other" id="aircraft_type_other" class="form-control" 
                               value="<?php echo Security::escape($old['aircraft_type_other'] ?? ''); ?>" placeholder="Enter aircraft type">
                    </div>
                    
                    <div class="form-group">
                        <label class="required">Model/Manufacturer</label>
                        <input type="text" name="model_manufacturer" value="<?php echo Security::escape($old['model_manufacturer'] ?? ''); ?>" 
                               required maxlength="100" class="form-control <?php echo isset($errors['model_manufacturer']) ? 'error' : ''; ?>"
                               placeholder="e.g., Bell 429, Cessna 172">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="year_manufacture" value="<?php echo Security::escape($old['year_manufacture'] ?? ''); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tail_number" value="<?php echo Security::escape($old['tail_number'] ?? ''); ?>" 
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="chassis_serial" value="<?php echo Security::escape($old['chassis_serial'] ?? ''); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="engine_type" value="<?php echo Security::escape($old['engine_type'] ?? ''); ?>" 
                               ...
                               placeholder="e.g., Turbofan, Turboprop">
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.1" name="flight_hours" value="<?php echo Security::escape($old['flight_hours'] ?? ''); ?>" 
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <textarea name="installed_equipment" rows="3" class="form-control" 
                                  placeholder="Radar, surveillance equipment, etc."><?php echo Security::escape($old['installed_equipment'] ?? ''); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="storage_location" value="<?php echo Security::escape($old['storage_location'] ?? ''); ?>" 
                               required class="form-control" placeholder="Hangar, Airfield, etc.">
                    </div>
                    
                    <div class="form-group">
                        <label class="required">Assigned Unit/Pilot</label>
                        <input type="text" name="assigned_unit_pilot" value="<?php echo Security::escape($old['assigned_unit_pilot'] ?? ''); ?>" 
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="insurance_type" required class="form-control <?php echo isset($errors['insurance_type']) ? 'error' : ''; ?>">
                            <option value="">Select Type</option>
                            <option value="Hull" <?php echo ($old['insurance_type'] ?? '') == 'Hull' ? 'selected' : ''; ?>>Hull</option>
                            <option value="Liability" <?php echo ($old['insurance_type'] ?? '') == 'Liability' ? 'selected' : ''; ?>>Liability</option>
                            <option value="Comprehensive" <?php echo ($old['insurance_type'] ?? '') == 'Comprehensive' ? 'selected' : ''; ?>>Comprehensive</option>
                        </select>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="last_maintenance" value="<?php echo Security::escape($old['last_maintenance'] ?? ''); ?>" 
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="next_overhaul" value="<?php echo Security::escape($old['next_overhaul'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-success submit-btn">
                    <i class="fas fa-save"></i> Save Aircraft
                </button>
                <button type="button" class="btn btn-secondary" onclick="resetForm('aircraftForm')">
                    <i class="fas fa-undo"></i> Reset Form
                </button>
                <a href="<?php echo BASE_URL; ?>/fleet/aircraft" class="btn btn-outline">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeSelect) {
        ...
        <?php if (($old['aircraft_type'] ?? '') === 'Other'): ?>
