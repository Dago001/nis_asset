...
$assetCode = $aircraft['asset_code'] ?? 'N/A';
$tailNumber = $aircraft['tail_number'] ?? 'N/A';
$modelManufacturer = $aircraft['model_manufacturer'] ?? 'Aircraft';
$yearManufacture = $aircraft['year_manufacture'] ?? 'N/A';
$aircraftType = !empty($aircraft['aircraft_type']) ? ($aircraft['aircraft_type'] === 'Other' ? ($aircraft['aircraft_type_other'] ?? 'Other') : $aircraft['aircraft_type']) : 'N/A';
$opStatus = $aircraft['operational_status'] ?? 'Operational';
$storageLocation = $aircraft['storage_location'] ?? 'N/A';
$assignedUnitPilot = $aircraft['assigned_unit_pilot'] ?? 'N/A';
$flightHours = isset($aircraft['flight_hours']) ? number_format((float)$aircraft['flight_hours'], 1) : '0.0';
$capitalValue = isset($aircraft['capital_value']) ? '₦' . number_format((float)$aircraft['capital_value'], 2) : 'N/A';

$fullLocation = implode(', ', array_filter([
    $aircraft['command_name'] ?? null,
    $aircraft['state_name'] ?? null
])) ?: 'Not Specified';

$documents = $documents ?? [];
?>

<div class="container-fluid aircraft-show-container">
    <!-- Page Header & Action Bar -->
    <div class="page-header">
        <div class="header-content">
            <div class="header-breadcrumb">
                <a href="<?php echo BASE_URL; ?>/fleet/aircraft"><i class="fas fa-plane"></i> Fleet Management</a>
                <span class="breadcrumb-separator"><i class="fas fa-chevron-right"></i></span>
                <span class="breadcrumb-current">Aircraft Details</span>
            </div>
            <h1 class="page-title">
                <?php echo Security::escape($modelManufacturer . ($yearManufacture !== 'N/A' ? ' (' . $yearManufacture . ')' : '')); ?>
                <span class="header-badge-code" title="Click to copy Tail #" onclick="copyToClipboard('<?php echo Security::escape($tailNumber); ?>', 'Tail #')">
                    <?php echo Security::escape($tailNumber); ?> <i class="fas fa-copy copy-icon"></i>
                </span>
            </h1>
        </div>
        <div class="header-actions">
            <a href="<?php echo BASE_URL; ?>/fleet/aircraft" class="pro-btn pro-btn-secondary">
                <i class="fas fa-arrow-left"></i> <span>Back</span>
            </a>
            <?php if (Auth::can('fleet.edit') && !empty($aircraftId)): ?>
            <a href="<?php echo BASE_URL; ?>/fleet/aircraft/edit/<?php echo $aircraftId; ?>" class="pro-btn pro-btn-primary">
                <i class="fas fa-edit"></i> <span>Edit Aircraft</span>
            </a>
            <?php endif; ?>
    ...
    <div class="kpi-metrics-grid">
        <div class="kpi-card">
            <div class="kpi-icon icon-serial"><i class="fas fa-plane"></i></div>
            <div class="kpi-details">
                <span class="kpi-label">Tail / Reg Number</span>
                <span class="kpi-value text-mono font-medium"><?php echo Security::escape($tailNumber); ?></span>
            </div>
        </div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-details">
                ...
                <span class="kpi-value">
                    ...
                    if ($opStatus === 'Maintenance') $badgeClass = 'badge-warning';
                    elseif ($opStatus === 'Grounded') $badgeClass = 'badge-danger';
                    ?>
                    <span class="custom-badge <?php echo $badgeClass; ?>"><?php echo Security::escape($opStatus); ?></span>
                </span>
            </div>
        </div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-details">
                <span class="kpi-label">Base Location / Hangar</span>
                <span class="kpi-value font-medium"><?php echo Security::escape($storageLocation); ?></span>
            </div>
        </div>

        <div class="kpi-card">
            <div class="kpi-icon icon-hours"><i class="fas fa-clock"></i></div>
            <div class="kpi-details">
                <span class="kpi-label">Flight Hours</span>
                <span class="kpi-value font-medium"><?php echo Security::escape($flightHours); ?> hrs</span>
            </div>
        </div>
    </div>
    ...
    <div class="show-layout-grid">
        ...
        <div class="show-main-column">
            ...
            <!-- 1. Location & Assignment Information Card -->
            <div class="pro-card">
                ...
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                            ...
                            <span class="item-value font-medium"><?php echo Security::escape($aircraft['zone_name'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Command / Formation</span>
                            <span class="item-value font-medium"><?php echo Security::escape($aircraft['command_name'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">State</span>
                            <span class="item-value font-medium"><?php echo Security::escape($aircraft['state_name'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Local Government Area (LGA)</span>
                            <span class="item-value font-medium"><?php echo Security::escape($aircraft['lga_name'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Storage Location / Hangar</span>
                            <span class="item-value font-medium"><?php echo Security::escape($storageLocation); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Assigned Unit / Pilot</span>
                            <span class="item-value font-medium"><?php echo Security::escape($assignedUnitPilot); ?></span>
                        </div>
                    </div>
                </div>
            </div>

            <!-- 2. Basic Information & Aircraft Specifications -->
            <div class="pro-card">
                <div class="pro-card-header">
                    <h3><i class="fas fa-sliders"></i> Basic Information & Specifications</h3>
                </div>
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                        ...
                        <div class="pro-detail-item">
                            <span class="item-label">Tail / Registration Number</span>
                            <span class="item-value text-mono font-medium text-success"><?php echo Security::escape($tailNumber); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Aircraft Type</span>
                            <span class="item-value font-medium"><?php echo Security::escape($aircraftType); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Model & Manufacturer</span>
                            <span class="item-value font-medium"><?php echo Security::escape($modelManufacturer); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Year of Manufacture</span>
                            <span class="item-value font-medium"><?php echo Security::escape($yearManufacture); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Chassis / Serial Number</span>
                            <span class="item-value text-mono font-medium"><?php echo Security::escape($aircraft['chassis_serial'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Engine Type</span>
                            <span class="item-value font-medium"><?php echo Security::escape($aircraft['engine_type'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Use / Purpose</span>
                            <span class="item-value font-medium"><?php echo Security::escape($aircraft['use_purpose'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Ownership Type</span>
                            <span class="item-value font-medium"><?php echo Security::escape($aircraft['ownership_type'] ?? 'N/A'); ?></span>
                        </div>
                    </div>
                </div>
            </div>

            <!-- 3. Operational Details & Systems Card -->
            <div class="pro-card">
                <div class="pro-card-header">
                    <h3><i class="fas fa-chart-line"></i> Operational Details & Installed Systems</h3>
                </div>
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                            <span class="item-label">Operational Status</span>
                            <span class="item-value font-medium">
                                <span class="custom-badge <?php echo $badgeClass; ?>"><?php echo Security::escape($opStatus); ?></span>
                            </span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Flight Hours</span>
                            <span class="item-value font-medium"><?php echo Security::escape($flightHours); ?> hrs</span>
                        </div>
                        <div class="pro-detail-item full-width">
                            <span class="item-label">Installed Equipment / Avionics</span>
                            <span class="item-value font-medium"><?php echo !empty($aircraft['installed_equipment']) ? nl2br(Security::escape($aircraft['installed_equipment'])) : 'None Specified'; ?></span>
                        </div>
                    </div>
                </div>
            </div>

            <!-- 4. Acquisition & Financial Valuation Card -->
            <div class="pro-card">
                <div class="pro-card-header">
                ...
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                            ...
                            <span class="item-value font-medium"><?php echo Security::escape($aircraft['acquisition_type'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Acquisition Date</span>
                            <span class="item-value font-medium"><?php echo !empty($aircraft['acquisition_date']) ? date('d/m/Y', strtotime($aircraft['acquisition_date'])) : 'N/A'; ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Capital Value</span>
                            <span class="item-value font-medium text-success"><?php echo Security::escape($capitalValue); ?></span>
                        </div>
                    </div>
                </div>
            </div>

            <!-- 5. Insurance & Maintenance Card -->
            <div class="pro-card">
                <div class="pro-card-header">
                    <h3><i class="fas fa-shield-alt"></i> Insurance & Maintenance Schedule</h3>
                </div>
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                            <span class="item-label">Insurance Type</span>
                            <span class="item-value font-medium"><?php echo Security::escape($aircraft['insurance_type'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Insurance Status</span>
                            <span class="item-value font-medium">
                                <?php
                                $insStatus = $aircraft['insurance_status'] ?? 'N/A';
                        ...
                        <div class="pro-detail-item">
                            ...
                            <span class="item-value font-medium"><?php echo !empty($aircraft['insurance_expiry']) ? date('d/m/Y', strtotime($aircraft['insurance_expiry'])) : 'N/A'; ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Last Maintenance Date</span>
                            <span class="item-value font-medium"><?php echo !empty($aircraft['last_maintenance']) ? date('d/m/Y', strtotime($aircraft['last_maintenance'])) : 'N/A'; ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Next Overhaul Due</span>
                            <span class="item-value font-medium"><?php echo !empty($aircraft['next_overhaul']) ? date('d/m/Y', strtotime($aircraft['next_overhaul'])) : 'N/A'; ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- 6. Remarks Card -->
            <?php if (!empty($aircraft['remarks'])): ?>
            <div class="pro-card">
                <div class="pro-card-header">
                    <h3><i class="fas fa-sticky-note"></i> Remarks & Additional Notes</h3>
                </div>
                <div class="pro-card-body">
                    <p class="remarks-text font-medium"><?php echo nl2br(Security::escape($aircraft['remarks'])); ?></p>
                </div>
            </div>
            <?php endif; ?>

            <!-- 7. Supporting Documents Section -->
            <div class="pro-card">
                <div class="pro-card-header flex-between">
                    <h3><i class="fas fa-folder-open"></i> Aircraft Attachments & Documents</h3>
                ...
                <div class="pro-card-body">
                    ...
                    <div class="empty-docs-state">
                        ...
                        <p>No supporting documents uploaded for this aircraft.</p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="show-sidebar-column">
            ...
            <div class="pro-card">
                ...
                <div class="pro-card-body">
                    ...
                    <div class="pro-side-item">
                        <span class="side-label">Tail Number</span>
                        <span class="side-value text-mono font-medium text-success"><?php echo Security::escape($tailNumber); ?></span>
                    </div>
                    <div class="pro-side-item">
                        <span class="side-label">Logged By</span>
                        <span class="side-value font-medium"><?php echo Security::escape($aircraft['created_by_name'] ?? 'System Admin'); ?></span>
                    </div>
                    <div class="pro-side-item">
                        <span class="side-label">Created Date</span>
                        <span class="side-value text-mono small"><?php echo !empty($aircraft['created_at']) ? date('d/m/Y H:i', strtotime($aircraft['created_at'])) : 'N/A'; ?></span>
                    </div>
                    <div class="pro-side-item">
                        <span class="side-label">Last Updated</span>
                        <span class="side-value text-mono small"><?php echo !empty($aircraft['updated_at']) ? date('d/m/Y H:i', strtotime($aircraft['updated_at'])) : 'N/A'; ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="pro-card">
                ...
                <div class="pro-card-body">
                    <div class="pro-side-item">
                        <span class="side-label">Primary Purpose</span>
                        <span class="side-value font-medium"><?php echo Security::escape($aircraft['use_purpose'] ?? 'N/A'); ?></span>
                    </div>
                    <div class="pro-side-item">
                        <span class="side-label">Ownership</span>
                        <span class="side-value font-medium"><?php echo Security::escape($aircraft['ownership_type'] ?? 'N/A'); ?></span>
                    </div>
                    <div class="pro-side-item">
                        <span class="side-label">Insurance</span>
                        <span class="side-value font-medium"><?php echo Security::escape($aircraft['insurance_status'] ?? 'N/A'); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
.aircraft-show-container { padding-bottom: 40px; }
.aircraft-show-container .page-header { display: flex !important; justify-content: space-between !important; align-items: center !important; flex-wrap: wrap !important; gap: 16px !important; background: #ffffff !important; padding: 20px 24px !important; border-radius: 12px !important; border: 1px solid #E2E8F0 !important; margin-bottom: 24px !important; }
.aircraft-show-container .header-content { flex: 1 1 280px !important; }
.aircraft-show-container .header-content h1.page-title { font-size: 1.25rem !important; font-weight: 600 !important; color: #1E293B !important; margin: 4px 0 0 0 !important; display: flex !important; align-items: center !important; flex-wrap: wrap !important; gap: 10px !important; letter-spacing: normal !important; }
...
.aircraft-show-container .header-actions { display: flex !important; align-items: center !important; gap: 10px !important; }
...
.icon-hours { background: #F3E8FF; color: #9333EA; }
...
@media (max-width: 768px) {
    .aircraft-show-container .page-header { flex-direction: column !important; align-items: stretch !important; padding: 16px !important; gap: 14px !important; }
    .aircraft-show-container .header-content { width: 100% !important; }
    .aircraft-show-container .header-actions { display: grid !important; grid-template-columns: repeat(3, 1fr) !important; gap: 8px !important; width: 100% !important; }
    .aircraft-show-container .header-actions .pro-btn { width: 100% !important; padding: 8px 6px !important; font-size: 0.8rem !important; }
    .pro-detail-grid { grid-template-columns: 1fr; }
    .pro-bottom-actions { flex-direction: column; }
    .pro-bottom-actions .pro-btn { width: 100%; }
}
@media (max-width: 480px) { .kpi-metrics-grid { grid-template-columns: 1fr; } .aircraft-show-container .header-actions { grid-template-columns: 1fr !important; } }
</style>
