...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="header-content">
            <h1>
                ...
                Edit Aircraft: <?php echo htmlspecialchars($aircraft['tail_number'] ?? ''); ?>
            </h1>
            <p>Update aircraft information</p>
        </div>
        <div class="header-actions">
            <a href="<?php echo BASE_URL; ?>/fleet/aircraft/show/<?php echo $aircraft['id'] ?? ''; ?>" class="btn btn-info">
                <i class="fas fa-eye"></i> View Details
            </a>
            <a href="<?php echo BASE_URL; ?>/fleet/aircraft" class="btn btn-secondary">
    ...
    <div class="form-section">
        <form method="POST" action="<?php echo BASE_URL; ?>/fleet/aircraft/update/<?php echo $aircraft['id'] ?? ''; ?>" 
              enctype="multipart/form-data" id="aircraftForm">
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo htmlspecialchars($aircraft['asset_code'] ?? ''); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <select name="use_purpose" required class="form-control <?php echo isset($errors['use_purpose']) ? 'error' : ''; ?>">
                            ...
                            <option value="Operational" <?php echo ($aircraft['use_purpose'] ?? '') == 'Operational' ? 'selected' : ''; ?>>Operational</option>
                            <option value="Transport" <?php echo ($aircraft['use_purpose'] ?? '') == 'Transport' ? 'selected' : ''; ?>>Transport</option>
                            <option value="Training" <?php echo ($aircraft['use_purpose'] ?? '') == 'Training' ? 'selected' : ''; ?>>Training</option>
                            <option value="Surveillance" <?php echo ($aircraft['use_purpose'] ?? '') == 'Surveillance' ? 'selected' : ''; ?>>Surveillance</option>
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="ownership_type" required class="form-control <?php echo isset($errors['ownership_type']) ? 'error' : ''; ?>">
                            ...
                            <option value="FGN-Owned" <?php echo ($aircraft['ownership_type'] ?? '') == 'FGN-Owned' ? 'selected' : ''; ?>>FGN-Owned</option>
                            <option value="Donor" <?php echo ($aircraft['ownership_type'] ?? '') == 'Donor' ? 'selected' : ''; ?>>Donor</option>
                            <option value="Leased" <?php echo ($aircraft['ownership_type'] ?? '') == 'Leased' ? 'selected' : ''; ?>>Leased</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="aircraft_type" id="aircraft_type" required class="form-control <?php echo isset($errors['aircraft_type']) ? 'error' : ''; ?>">
                            <option value="">Select Type</option>
                            <option value="Helicopter" <?php echo ($aircraft['aircraft_type'] ?? '') == 'Helicopter' ? 'selected' : ''; ?>>Helicopter</option>
                            <option value="Fixed Wing" <?php echo ($aircraft['aircraft_type'] ?? '') == 'Fixed Wing' ? 'selected' : ''; ?>>Fixed Wing</option>
                            <option value="Jet" <?php echo ($aircraft['aircraft_type'] ?? '') == 'Jet' ? 'selected' : ''; ?>>Jet</option>
                            <option value="Propeller" <?php echo ($aircraft['aircraft_type'] ?? '') == 'Propeller' ? 'selected' : ''; ?>>Propeller</option>
                            <option value="Other">Other</option>
                        </select>
                        <?php if (isset($errors['aircraft_type'])): ?>
                            <small class="error-text"><?php echo $errors['aircraft_type']; ?></small>
                        <?php endif; ?>
                    </div>
                    
                    <div class="form-group" id="typeOtherWrapper" style="display: none;">
                        <label>Specify Aircraft Type</label>
                        <input type="text" name="aircraft_type_other" id="aircraft_type_other" class="form-control" 
                               value="<?php echo htmlspecialchars($aircraft['aircraft_type_other'] ?? ''); ?>" placeholder="Enter aircraft type">
                    </div>
                </div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label class="required">Model/Manufacturer</label>
                        <input type="text" name="model_manufacturer" value="<?php echo htmlspecialchars($aircraft['model_manufacturer'] ?? ''); ?>" 
                               required maxlength="100" class="form-control <?php echo isset($errors['model_manufacturer']) ? 'error' : ''; ?>">
                        <?php if (isset($errors['model_manufacturer'])): ?>
                            <small class="error-text"><?php echo $errors['model_manufacturer']; ?></small>
                        <?php endif; ?>
                    </div>
                    
                    <div class="form-group">
                        <label class="required">Year of Manufacture</label>
                        <input type="number" name="year_manufacture" value="<?php echo htmlspecialchars($aircraft['year_manufacture'] ?? ''); ?>" 
                               required min="1900" max="<?php echo date('Y'); ?>" 
                               class="form-control <?php echo isset($errors['year_manufacture']) ? 'error' : ''; ?>">
                        <?php if (isset($errors['year_manufacture'])): ?>
                            <small class="error-text"><?php echo $errors['year_manufacture']; ?></small>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label class="required">Tail Number</label>
                        <input type="text" name="tail_number" value="<?php echo htmlspecialchars($aircraft['tail_number'] ?? ''); ?>" 
                               required maxlength="50" class="form-control <?php echo isset($errors['tail_number']) ? 'error' : ''; ?>">
                        <?php if (isset($errors['tail_number'])): ?>
                            <small class="error-text"><?php echo $errors['tail_number']; ?></small>
                        <?php endif; ?>
                    </div>
                    
                    <div class="form-group">
                        <label class="required">Chassis/Serial Number</label>
                        <input type="text" name="chassis_serial" value="<?php echo htmlspecialchars($aircraft['chassis_serial'] ?? ''); ?>" 
                               required maxlength="100" class="form-control <?php echo isset($errors['chassis_serial']) ? 'error' : ''; ?>">
                        <?php if (isset($errors['chassis_serial'])): ?>
                            <small class="error-text"><?php echo $errors['chassis_serial']; ?></small>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="engine_type" value="<?php echo htmlspecialchars($aircraft['engine_type'] ?? ''); ?>" 
            ...
            <div class="form-section-inner">
                <div class="section-title">
                    <h3><i class="fas fa-chart-line"></i> Operational Details</h3>
                </div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label>Flight Hours</label>
                        <input type="number" step="0.1" name="flight_hours" value="<?php echo htmlspecialchars($aircraft['flight_hours'] ?? ''); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <select name="operational_status" required class="form-control <?php echo isset($errors['operational_status']) ? 'error' : ''; ?>">
                            ...
                            <option value="Operational" <?php echo ($aircraft['operational_status'] ?? '') == 'Operational' ? 'selected' : ''; ?>>Operational</option>
                            <option value="Maintenance" <?php echo ($aircraft['operational_status'] ?? '') == 'Maintenance' ? 'selected' : ''; ?>>Maintenance</option>
                            <option value="Grounded" <?php echo ($aircraft['operational_status'] ?? '') == 'Grounded' ? 'selected' : ''; ?>>Grounded</option>
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <textarea name="installed_equipment" rows="3" class="form-control"><?php echo htmlspecialchars($aircraft['installed_equipment'] ?? ''); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="acquisition_type" required class="form-control <?php echo isset($errors['acquisition_type']) ? 'error' : ''; ?>">
                            <option value="">Select Type</option>
                            <option value="Purchase" <?php echo ($aircraft['acquisition_type'] ?? '') == 'Purchase' ? 'selected' : ''; ?>>Purchase</option>
                            <option value="Transfer" <?php echo ($aircraft['acquisition_type'] ?? '') == 'Transfer' ? 'selected' : ''; ?>>Transfer</option>
                            <option value="Donation" <?php echo ($aircraft['acquisition_type'] ?? '') == 'Donation' ? 'selected' : ''; ?>>Donation</option>
                            <option value="Lease" <?php echo ($aircraft['acquisition_type'] ?? '') == 'Lease' ? 'selected' : ''; ?>>Lease</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="acquisition_date" value="<?php echo htmlspecialchars($aircraft['acquisition_date'] ?? ''); ?>" 
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="capital_value" value="<?php echo htmlspecialchars($aircraft['capital_value'] ?? ''); ?>" 
            ...
            <div class="form-section-inner">
                    ...
                    <div class="form-group">
                        ...
                        <select name="state_id" id="state_id" required 
                            ...
                            <option value="<?php echo $state['id']; ?>" 
                                    <?php echo ($aircraft['state_id'] ?? '') == $state['id'] ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="zone_id" id="zone_id" required 
                            ...
                            <option value="<?php echo $zone['id']; ?>" 
                                    <?php echo ($aircraft['zone_id'] ?? '') == $zone['id'] ? 'selected' : ''; ?>>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="storage_location" value="<?php echo htmlspecialchars($aircraft['storage_location'] ?? ''); ?>" 
                               required class="form-control">
                    </div>
                    
                    <div class="form-group">
                        <label class="required">Assigned Unit/Pilot</label>
                        <input type="text" name="assigned_unit_pilot" value="<?php echo htmlspecialchars($aircraft['assigned_unit_pilot'] ?? ''); ?>" 
                               required class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section-inner">
                <div class="section-title">
                    <h3><i class="fas fa-shield-alt"></i> Insurance & Maintenance</h3>
                </div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label class="required">Insurance Type</label>
                        <select name="insurance_type" required class="form-control <?php echo isset($errors['insurance_type']) ? 'error' : ''; ?>">
                            <option value="">Select Type</option>
                            <option value="Hull" <?php echo ($aircraft['insurance_type'] ?? '') == 'Hull' ? 'selected' : ''; ?>>Hull</option>
                            <option value="Liability" <?php echo ($aircraft['insurance_type'] ?? '') == 'Liability' ? 'selected' : ''; ?>>Liability</option>
                            <option value="Comprehensive" <?php echo ($aircraft['insurance_type'] ?? '') == 'Comprehensive' ? 'selected' : ''; ?>>Comprehensive</option>
                        </select>
                        <?php if (isset($errors['insurance_type'])): ?>
                            <small class="error-text"><?php echo $errors['insurance_type']; ?></small>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="insurance_status" id="insurance_status" required class="form-control <?php echo isset($errors['insurance_status']) ? 'error' : ''; ?>">
                            <option value="">Select Status</option>
                            <option value="Valid" <?php echo ($aircraft['insurance_status'] ?? '') == 'Valid' ? 'selected' : ''; ?>>Valid</option>
                            <option value="Expired" <?php echo ($aircraft['insurance_status'] ?? '') == 'Expired' ? 'selected' : ''; ?>>Expired</option>
                            <option value="Not Insured" <?php echo ($aircraft['insurance_status'] ?? '') == 'Not Insured' ? 'selected' : ''; ?>>Not Insured</option>
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="insurance_expiry" id="insurance_expiry" 
                               value="<?php echo htmlspecialchars($aircraft['insurance_expiry'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                    
                    <div class="form-group">
                        <label>Last Maintenance Date</label>
                        <input type="date" name="last_maintenance" value="<?php echo htmlspecialchars($aircraft['last_maintenance'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Next Overhaul Date</label>
                        <input type="date" name="next_overhaul" value="<?php echo htmlspecialchars($aircraft['next_overhaul'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-group">
                    <textarea name="remarks" rows="3" class="form-control"><?php echo htmlspecialchars($aircraft['remarks'] ?? ''); ?></textarea>
                </div>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-success submit-btn">
                    <i class="fas fa-save"></i> Update Aircraft
                </button>
                <a href="<?php echo BASE_URL; ?>/fleet/aircraft/show/<?php echo $aircraft['id'] ?? ''; ?>" class="btn btn-outline">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Aircraft type other field
    const typeSelect = document.getElementById('aircraft_type');
    const typeWrapper = document.getElementById('typeOtherWrapper');
    const typeOther = document.getElementById('aircraft_type_other');
    ...
    if (typeSelect) {
        ...
        <?php if (($aircraft['aircraft_type'] ?? '') === 'Other'): ?>
    ...
    if (stateSelect) {
            ...
            fetch(apiUrl)
                ...
                .then(data => {
                    ...
                    if (data && data.length > 0) {
                        ...
                        <?php if (!empty($aircraft['lga_id'])): ?>
                        lgaSelect.value = '<?php echo $aircraft['lga_id']; ?>';
                        <?php endif; ?>
                    }
                })
                .catch(error => {
        ...
        <?php if (!empty($aircraft['state_id'])): ?>
        stateSelect.value = '<?php echo $aircraft['state_id']; ?>';
    ...
    if (zoneSelect) {
            ...
            fetch(apiUrl)
                ...
                .then(data => {
                    ...
                    if (data && data.length > 0) {
                        ...
                        <?php if (!empty($aircraft['command_id'])): ?>
                        commandSelect.value = '<?php echo $aircraft['command_id']; ?>';
                        <?php endif; ?>
                    }
                })
                .catch(error => {
        ...
        <?php if (!empty($aircraft['zone_id'])): ?>
        zoneSelect.value = '<?php echo $aircraft['zone_id']; ?>';
...
function removeDocument(button, docId) {
    if (confirm('Are you sure you want to remove this document?')) {
        ...
        input.value = docId;
        document.getElementById('aircraftForm').appendChild(input);
