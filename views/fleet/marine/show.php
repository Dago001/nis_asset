<?php
$title = 'Marine Craft Details';
$active = 'marine';
require_once __DIR__ . '/../../layouts/header.php';
require_once __DIR__ . '/../../layouts/sidebar.php';

$marineId = $marine['id'] ?? 0;
$assetCode = $marine['asset_code'] ?? 'N/A';
$regNo = $marine['registration_number'] ?? 'N/A';
$vesselName = $marine['vessel_name'] ?? 'Marine Vessel';
$boatType = !empty($marine['boat_type']) ? ($marine['boat_type'] === 'Other' ? ($marine['boat_type_other'] ?? 'Other') : $marine['boat_type']) : 'N/A';
$opStatus = $marine['operational_status'] ?? 'Operational';
$condition = $marine['condition'] ?? 'Good';
$dockingLocation = $marine['docking_location'] ?? 'N/A';
$assignedCrewUnit = $marine['assigned_crew_unit'] ?? 'N/A';
$capitalValue = isset($marine['capital_value']) ? '₦' . number_format((float)$marine['capital_value'], 2) : 'N/A';

$fullLocation = implode(', ', array_filter([
    $marine['command_name'] ?? null,
    $marine['state_name'] ?? null
])) ?: 'Not Specified';

$documents = $documents ?? [];
?>

<div class="container-fluid marine-show-container">
    <!-- Page Header & Action Bar -->
    <div class="page-header">
        <div class="header-content">
            <div class="header-breadcrumb">
                <a href="<?php echo BASE_URL; ?>/fleet/marine"><i class="fas fa-ship"></i> Fleet Management</a>
                <span class="breadcrumb-separator"><i class="fas fa-chevron-right"></i></span>
                <span class="breadcrumb-current">Marine Craft Details</span>
            </div>
            <h1 class="page-title">
                <?php echo Security::escape($vesselName); ?>
        ...
        <div class="header-actions">
            <a href="<?php echo BASE_URL; ?>/fleet/marine" class="pro-btn pro-btn-secondary">
                <i class="fas fa-arrow-left"></i> <span>Back</span>
            </a>
            <?php if (Auth::can('fleet.edit') && !empty($marineId)): ?>
            <a href="<?php echo BASE_URL; ?>/fleet/marine/edit/<?php echo $marineId; ?>" class="pro-btn pro-btn-primary">
    ...
    <div class="kpi-metrics-grid">
        <div class="kpi-card">
            <div class="kpi-icon icon-serial"><i class="fas fa-ship"></i></div>
            <div class="kpi-details">
                <span class="kpi-label">Vessel Reg Number</span>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-details">
                ...
                <span class="kpi-value">
                    ...
                    if ($opStatus === 'Maintenance' || $opStatus === 'Docked') $badgeClass = 'badge-warning';
                    elseif ($opStatus === 'Decommissioned') $badgeClass = 'badge-danger';
                    ?>
        ...
        <div class="kpi-card">
            <div class="kpi-icon icon-location"><i class="fas fa-anchor"></i></div>
            <div class="kpi-details">
                <span class="kpi-label">Docking Location</span>
                <span class="kpi-value font-medium"><?php echo Security::escape($dockingLocation); ?></span>
            </div>
        </div>

        <div class="kpi-card">
            <div class="kpi-icon icon-crew"><i class="fas fa-users"></i></div>
            <div class="kpi-details">
                <span class="kpi-label">Assigned Crew / Unit</span>
                <span class="kpi-value font-medium"><?php echo Security::escape($assignedCrewUnit); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="show-layout-grid">
        ...
        <div class="show-main-column">
                ...
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                            ...
                            <span class="item-value font-medium"><?php echo Security::escape($marine['zone_name'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Command / Formation</span>
                            <span class="item-value font-medium"><?php echo Security::escape($marine['command_name'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">State</span>
                            <span class="item-value font-medium"><?php echo Security::escape($marine['state_name'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Local Government Area (LGA)</span>
                            <span class="item-value font-medium"><?php echo Security::escape($marine['lga_name'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Docking Location</span>
                            <span class="item-value font-medium"><?php echo Security::escape($dockingLocation); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Assigned Crew / Unit</span>
                            <span class="item-value font-medium"><?php echo Security::escape($assignedCrewUnit); ?></span>
                        </div>
                    </div>
                </div>
            </div>

            <!-- 2. Basic Information & Vessel Specifications -->
            <div class="pro-card">
                <div class="pro-card-header">
                    <h3><i class="fas fa-sliders-h"></i> Basic Information & Vessel Specifications</h3>
                </div>
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                        ...
                        <div class="pro-detail-item">
                            <span class="item-label">Vessel Registration #</span>
                            <span class="item-value text-mono font-medium text-success"><?php echo Security::escape($regNo); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Vessel Name</span>
                            <span class="item-value font-medium"><?php echo Security::escape($vesselName); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Boat Type</span>
                            <span class="item-value font-medium"><?php echo Security::escape($boatType); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Hull Identification #</span>
                            <span class="item-value text-mono font-medium"><?php echo Security::escape($marine['hull_identification'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Use / Purpose</span>
                            <span class="item-value font-medium"><?php echo Security::escape($marine['use_purpose'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Ownership Type</span>
                            <span class="item-value font-medium"><?php echo Security::escape($marine['ownership_type'] ?? 'N/A'); ?></span>
                        </div>
                    </div>
                </div>
            </div>

            <!-- 3. Engine & Propulsion Details Card -->
            <div class="pro-card">
                <div class="pro-card-header">
                    <h3><i class="fas fa-cogs"></i> Engine & Propulsion Details</h3>
                </div>
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                            <span class="item-label">Engine Type</span>
                            <span class="item-value font-medium"><?php echo Security::escape($marine['engine_type'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Engine Capacity</span>
                            <span class="item-value font-medium"><?php echo Security::escape($marine['engine_capacity'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Number of Engines</span>
                            <span class="item-value font-medium"><?php echo Security::escape($marine['number_engines'] ?? '1'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Fuel Type</span>
                            <span class="item-value font-medium"><?php echo Security::escape($marine['fuel_type'] ?? 'N/A'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                            ...
                            <span class="item-value font-medium"><?php echo Security::escape($marine['acquisition_type'] ?? 'N/A'); ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Acquisition Date</span>
                            <span class="item-value font-medium"><?php echo !empty($marine['acquisition_date']) ? date('d/m/Y', strtotime($marine['acquisition_date'])) : 'N/A'; ?></span>
                        </div>
                        <div class="pro-detail-item">
            ...
            <!-- 5. Operational Status & Dry Docking Schedule Card -->
            <div class="pro-card">
                <div class="pro-card-header">
                    <h3><i class="fas fa-clipboard-check"></i> Status & Maintenance Schedule</h3>
                </div>
                <div class="pro-card-body">
                    <div class="pro-detail-grid">
                        <div class="pro-detail-item">
                        ...
                        <div class="pro-detail-item">
                            <span class="item-label">Last Dry Docking Date</span>
                            <span class="item-value font-medium"><?php echo !empty($marine['last_dry_docking']) ? date('d/m/Y', strtotime($marine['last_dry_docking'])) : 'N/A'; ?></span>
                        </div>
                        <div class="pro-detail-item">
                            <span class="item-label">Next Dry Docking Due</span>
                            <span class="item-value font-medium"><?php echo !empty($marine['next_dry_docking']) ? date('d/m/Y', strtotime($marine['next_dry_docking'])) : 'N/A'; ?></span>
                        </div>
                        <div class="pro-detail-item full-width">
                            <span class="item-label">Onboard Equipment</span>
                            <span class="item-value font-medium"><?php echo !empty($marine['onboard_equipment']) ? nl2br(Security::escape($marine['onboard_equipment'])) : 'None Specified'; ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- 6. Remarks Card -->
            <?php if (!empty($marine['remarks'])): ?>
            <div class="pro-card">
                <div class="pro-card-header">
                    <h3><i class="fas fa-sticky-note"></i> Remarks & Additional Notes</h3>
                </div>
                <div class="pro-card-body">
                    <p class="remarks-text font-medium"><?php echo nl2br(Security::escape($marine['remarks'])); ?></p>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="pro-card">
                <div class="pro-card-header flex-between">
                    <h3><i class="fas fa-folder-open"></i> Vessel Attachments & Documents</h3>
                ...
                <div class="pro-card-body">
                    ...
                    <div class="empty-docs-state">
                        ...
                        <p>No supporting documents uploaded for this marine vessel.</p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="pro-card">
                ...
                <div class="pro-card-body">
                    ...
                    <div class="pro-side-item">
                        ...
                        <span class="side-value font-medium"><?php echo Security::escape($marine['created_by_name'] ?? 'System Admin'); ?></span>
                    </div>
                    <div class="pro-side-item">
                        <span class="side-label">Created Date</span>
                        <span class="side-value text-mono small"><?php echo !empty($marine['created_at']) ? date('d/m/Y H:i', strtotime($marine['created_at'])) : 'N/A'; ?></span>
                    </div>
                    <div class="pro-side-item">
                        <span class="side-label">Last Updated</span>
                        <span class="side-value text-mono small"><?php echo !empty($marine['updated_at']) ? date('d/m/Y H:i', strtotime($marine['updated_at'])) : 'N/A'; ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="pro-card">
                ...
                <div class="pro-card-body">
                    <div class="pro-side-item">
                        ...
                        <span class="side-value font-medium"><?php echo Security::escape($marine['use_purpose'] ?? 'N/A'); ?></span>
                    </div>
                    <div class="pro-side-item">
                        <span class="side-label">Ownership</span>
                        <span class="side-value font-medium"><?php echo Security::escape($marine['ownership_type'] ?? 'N/A'); ?></span>
                    </div>
                    <div class="pro-side-item">
...
.marine-show-container { padding-bottom: 40px; }
.marine-show-container .page-header { display: flex !important; justify-content: space-between !important; align-items: center !important; flex-wrap: wrap !important; gap: 16px !important; background: #ffffff !important; padding: 20px 24px !important; border-radius: 12px !important; border: 1px solid #E2E8F0 !important; margin-bottom: 24px !important; }
.marine-show-container .header-content { flex: 1 1 280px !important; }
.marine-show-container .header-content h1.page-title { font-size: 1.25rem !important; font-weight: 600 !important; color: #1E293B !important; margin: 4px 0 0 0 !important; display: flex !important; align-items: center !important; flex-wrap: wrap !important; gap: 10px !important; letter-spacing: normal !important; }
...
.marine-show-container .header-actions { display: flex !important; align-items: center !important; gap: 10px !important; }
...
.icon-crew { background: #F3E8FF; color: #9333EA; }
...
@media (max-width: 768px) {
    .marine-show-container .page-header { flex-direction: column !important; align-items: stretch !important; padding: 16px !important; gap: 14px !important; }
    .marine-show-container .header-content { width: 100% !important; }
    .marine-show-container .header-actions { display: grid !important; grid-template-columns: repeat(3, 1fr) !important; gap: 8px !important; width: 100% !important; }
    .marine-show-container .header-actions .pro-btn { width: 100% !important; padding: 8px 6px !important; font-size: 0.8rem !important; }
    .pro-detail-grid { grid-template-columns: 1fr; }
    .pro-bottom-actions { flex-direction: column; }
    .pro-bottom-actions .pro-btn { width: 100%; }
}
@media (max-width: 480px) { .kpi-metrics-grid { grid-template-columns: 1fr; } .marine-show-container .header-actions { grid-template-columns: 1fr !important; } }
</style>
