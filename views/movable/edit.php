...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="header-content">
            <h1>
                ...
                Edit Movable Asset: <?php echo Security::escape($asset['asset_code']); ?>
            </h1>
            <p>Update movable asset information</p>
        </div>
        <div class="header-actions">
            <a href="<?php echo BASE_URL; ?>/movable/show/<?php echo $asset['id']; ?>" class="btn btn-info">
    ...
    <div class="form-section">
        <form method="POST" action="<?php echo BASE_URL; ?>/movable/update/<?php echo $asset['id']; ?>" 
              enctype="multipart/form-data" id="movableForm">
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="asset_type" id="asset_type" required 
                            ...
                            <option value="Furniture" <?php echo $asset['asset_type'] == 'Furniture' ? 'selected' : ''; ?>>Furniture</option>
                            <option value="Office Equipment" <?php echo $asset['asset_type'] == 'Office Equipment' ? 'selected' : ''; ?>>Office Equipment</option>
                            <option value="Machinery" <?php echo $asset['asset_type'] == 'Machinery' ? 'selected' : ''; ?>>Machinery</option>
                            <option value="Generator" <?php echo $asset['asset_type'] == 'Generator' ? 'selected' : ''; ?>>Generator</option>
                            <option value="Tools" <?php echo $asset['asset_type'] == 'Tools' ? 'selected' : ''; ?>>Tools</option>
                            <option value="Appliances" <?php echo $asset['asset_type'] == 'Appliances' ? 'selected' : ''; ?>>Appliances</option>
                ...
                <div class="form-group" id="typeOtherWrapper" style="display: none;">
                    ...
                    <input type="text" name="asset_type_other" id="asset_type_other" class="form-control" 
                           value="<?php echo !in_array($asset['asset_type'] ?? '', ['Furniture', 'Office Equipment', 'Machinery', 'Generator', 'Tools', 'Appliances']) ? Security::escape($asset['asset_type'] ?? '') : ''; ?>" 
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="make_model" value="<?php echo Security::escape($asset['make_model']); ?>" 
                               required maxlength="255" class="form-control <?php echo isset($errors['make_model']) ? 'error' : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="serial_number" value="<?php echo Security::escape($asset['serial_number'] ?? ''); ?>" 
                ...
                <div class="form-group">
                    ...
                    <textarea name="capacity_specification" rows="2" class="form-control"><?php echo Security::escape($asset['capacity_specification'] ?? ''); ?></textarea>
                </div>
            </div>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="current_location" value="<?php echo Security::escape($asset['current_location'] ?? ''); ?>" 
                           class="form-control">
                </div>
            </div>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="custodian_name" value="<?php echo Security::escape($asset['custodian_name'] ?? ''); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <select name="custodian_rank" class="form-control">
                            ...
                            <?php foreach (getNisRanks() as $rank): ?>
                                <option value="<?php echo htmlspecialchars($rank); ?>" <?php echo ($asset['custodian_rank'] ?? '') === $rank ? 'selected' : ''; ?>>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="custodian_nis" value="<?php echo Security::escape($asset['custodian_nis'] ?? ''); ?>"
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="purchase_date" value="<?php echo Security::escape($asset['purchase_date'] ?? ''); ?>" 
                               class="form-control" max="<?php echo date('Y-m-d'); ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>Purchase Value (₦)</label>
                        <input type="number" step="0.01" name="purchase_value" value="<?php echo Security::escape($asset['purchase_value'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="current_value" value="<?php echo Security::escape($asset['current_value'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                    
                    <div class="form-group">
                        <label>Warranty Information</label>
                        <textarea name="warranty_info" rows="2" class="form-control"><?php echo Security::escape($asset['warranty_info'] ?? ''); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <textarea name="maintenance_schedule" rows="2" class="form-control"><?php echo Security::escape($asset['maintenance_schedule'] ?? ''); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="last_maintenance_date" value="<?php echo Security::escape($asset['last_maintenance_date'] ?? ''); ?>" 
                               class="form-control" max="<?php echo date('Y-m-d'); ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>Next Maintenance Date</label>
                        <input type="date" name="next_maintenance_date" value="<?php echo Security::escape($asset['next_maintenance_date'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-success submit-btn">
                    <i class="fas fa-save"></i> Update Movable Asset
                </button>
                <a href="<?php echo BASE_URL; ?>/movable/show/<?php echo $asset['id']; ?>" class="btn btn-outline">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeSelect) {
        ...
        <?php if (!in_array($asset['asset_type'] ?? '', ['Furniture', 'Office Equipment', 'Machinery', 'Generator', 'Tools', 'Appliances'])): ?>
...
function removeDocument(docId) {
    if (confirm('Are you sure you want to remove this document? This action cannot be undone.')) {
        ...
        input.value = docId;
        document.getElementById('movableForm').appendChild(input);
