...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="header-content">
            <h1>
                ...
                Edit Building Asset: <?php echo Security::escape($asset['building_name']); ?>
            </h1>
            <p>Update building asset information</p>
        </div>
        <div class="header-actions">
            <a href="<?php echo BASE_URL; ?>/buildings/show/<?php echo $asset['id']; ?>" class="btn btn-info">
    ...
    <div class="form-section">
        <form method="POST" action="<?php echo BASE_URL; ?>/buildings/update/<?php echo $asset['id']; ?>" 
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="purpose_function" id="purpose_function" required 
                            ...
                            <option value="Command / Formation" <?php echo ($asset['purpose_function'] ?? '') == 'Command / Formation' ? 'selected' : ''; ?>>Command / Formation</option>
                            <option value="Area Office" <?php echo ($asset['purpose_function'] ?? '') == 'Area Office' ? 'selected' : ''; ?>>Area Office</option>
                            <option value="Divisional Office" <?php echo ($asset['purpose_function'] ?? '') == 'Divisional Office' ? 'selected' : ''; ?>>Divisional Office</option>
                            <option value="PPT Office" <?php echo ($asset['purpose_function'] ?? '') == 'PPT Office' ? 'selected' : ''; ?>>PPT Office</option>
                            <option value="Control Post" <?php echo ($asset['purpose_function'] ?? '') == 'Control Post' ? 'selected' : ''; ?>>Control Post</option>
                            <option value="Barracks/Transit Camp" <?php echo ($asset['purpose_function'] ?? '') == 'Barracks/Transit Camp' ? 'selected' : ''; ?>>Barracks/Transit Camp</option>
                            <option value="FOB/MOB" <?php echo ($asset['purpose_function'] ?? '') == 'FOB/MOB' ? 'selected' : ''; ?>>FOB/MOB</option>
                            <option value="E-Border" <?php echo ($asset['purpose_function'] ?? '') == 'E-Border' ? 'selected' : ''; ?>>E-Border</option>
                            <option value="Flag House" <?php echo ($asset['purpose_function'] ?? '') == 'Flag House' ? 'selected' : ''; ?>>Flag House</option>
                            <option value="Zonal Command" <?php echo ($asset['purpose_function'] ?? '') == 'Zonal Command' ? 'selected' : ''; ?>>Zonal Command</option>
                            <option value="Migrant Holding Centers" <?php echo ($asset['purpose_function'] ?? '') == 'Migrant Holding Centers' ? 'selected' : ''; ?>>Migrant Holding Centers</option>
                    ...
                    <div class="form-group" id="purposeOtherWrapper" style="display: none;">
                        ...
                        <input type="text" name="purpose_other" id="purpose_other" class="form-control" 
                               placeholder="Enter purpose/function" value="<?php echo Security::escape($asset['purpose_other'] ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="building_name" value="<?php echo Security::escape($asset['building_name']); ?>" 
                               required maxlength="255" class="form-control <?php echo isset($errors['building_name']) ? 'error' : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select name="building_type" id="building_type" required 
                            ...
                            <option value="Office" <?php echo $asset['building_type'] == 'Office' ? 'selected' : ''; ?>>Office</option>
                            <option value="Residential" <?php echo $asset['building_type'] == 'Residential' ? 'selected' : ''; ?>>Residential</option>
                            <option value="Warehouse" <?php echo $asset['building_type'] == 'Warehouse' ? 'selected' : ''; ?>>Warehouse</option>
                            <option value="Barracks" <?php echo $asset['building_type'] == 'Barracks' ? 'selected' : ''; ?>>Barracks</option>
                            <option value="Training Facility" <?php echo $asset['building_type'] == 'Training Facility' ? 'selected' : ''; ?>>Training Facility</option>
                            <option value="Medical Center" <?php echo $asset['building_type'] == 'Medical Center' ? 'selected' : ''; ?>>Medical Center</option>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="floor_count" value="<?php echo Security::escape($asset['floor_count'] ?? ''); ?>" 
                               min="1" class="form-control">
                    </div>
                    
                    <div class="form-group">
                        <label>Total Area (m²)</label>
                        <input type="number" step="0.01" name="total_area" value="<?php echo Security::escape($asset['total_area'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="land_id" id="land_id" class="form-control">
                            ...
                            <option value="<?php echo $land['id']; ?>" 
                                    <?php echo $asset['land_id'] == $land['id'] ? 'selected' : ''; ?>>
            ...
            <div class="form-section-inner">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="construction_contractor" 
                               value="<?php echo Security::escape($asset['construction_contractor'] ?? ''); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="contract_sum" 
                               value="<?php echo Security::escape($asset['contract_sum'] ?? ''); ?>" 
                               class="form-control">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="date_awarded" value="<?php echo Security::escape($asset['date_awarded'] ?? ''); ?>" 
                               class="form-control" max="<?php echo date('Y-m-d'); ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>Completion Date</label>
                        <input type="date" name="completion_date" value="<?php echo Security::escape($asset['completion_date'] ?? ''); ?>" 
                               class="form-control" max="<?php echo date('Y-m-d'); ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="date_occupied" value="<?php echo Security::escape($asset['date_occupied'] ?? ''); ?>" 
                               class="form-control" max="<?php echo date('Y-m-d'); ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="condition_status" id="condition_status" required 
                            ...
                            <option value="Under Maintenance" <?php echo ($asset['condition_status'] ?? '') == 'Under Maintenance' ? 'selected' : ''; ?>>Under Maintenance</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="last_maintenance_date" 
                               value="<?php echo Security::escape($asset['last_maintenance_date'] ?? ''); ?>" 
                               class="form-control" max="<?php echo date('Y-m-d'); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-success submit-btn">
                    <i class="fas fa-save"></i> Update Building Asset
                </button>
                <a href="<?php echo BASE_URL; ?>/buildings/show/<?php echo $asset['id']; ?>" class="btn btn-outline">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (purposeSelect) {
        purposeSelect.addEventListener('change', function() {
            if (this.value === 'Others') {
                ...
                if (purposeOther) purposeOther.required = true;
            } else {
        ...
        <?php if (($asset['purpose_function'] ?? '') === 'Others'): ?>
        purposeWrapper.style.display = 'block';
        <?php endif; ?>
    }
    ...
    if (typeSelect && !typeOtherWrapper) {
        ...
        <?php if (!in_array($asset['building_type'] ?? '', ['Office', 'Residential', 'Warehouse', 'Barracks', 'Training Facility', 'Medical Center'])): ?>
        typeSelect.value = 'Other';
        typeSelect.dispatchEvent(new Event('change'));
        if (typeOther) typeOther.value = '<?php echo Security::escape($asset['building_type']); ?>';
        <?php endif; ?>
    }
