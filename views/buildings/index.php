...
$title = 'Building Assets Management';
$active = 'buildings';
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p>Manage all building and structural assets</p>
        </div>
        <div class="header-actions">
            <?php if (Auth::can('building.create')): ?>
            <a href="<?php echo BASE_URL; ?>/buildings/create" class="btn btn-success">
                <i class="fas fa-plus-circle"></i> Add New Building
            </a>
            <?php endif; ?>
            <?php if (Auth::can('reports.export')): ?>
            <a href="<?php echo BASE_URL; ?>/buildings/export" class="btn btn-outline">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-details">
                <h4>In Use</h4>
                <p class="stat-number"><?php echo number_format($statistics['by_condition']['In Use'] ?? 0); ?></p>
            </div>
        </div>
        <div class="stat-card">
            ...
            <div class="stat-details">
                ...
                <p class="stat-number"><?php echo number_format($statistics['by_condition']['Under Maintenance'] ?? 0); ?></p>
            </div>
        </div>
        <div class="stat-card">
    ...
    <div class="filter-section">
        <div class="filter-header" onclick="toggleFilters()">
            <h3><i class="fas fa-filter"></i> Filter Buildings</h3>
        ...
        <div class="filter-body" id="filterBody" style="display: block;">
            <div class="filter-grid">
                <div class="filter-group">
                    <label>Search</label>
                    <input type="text" id="searchBuildings" class="form-control" placeholder="Search by name, code, address...">
                </div>
                <div class="filter-group">
    ...
    <div class="content-card">
        <div class="section-title">
            <h2><i class="fas fa-list"></i> Buildings Register</h2>
        ...
        <div class="table-responsive">
            <?php if (empty($assets)): ?>
                <div class="empty-state">
                    <i class="fas fa-building"></i>
                    <p>No building assets found</p>
                    <?php if (Auth::can('building.create')): ?>
                    <a href="<?php echo BASE_URL; ?>/buildings/create" class="btn btn-primary">
                        <i class="fas fa-plus"></i> Add First Building
                    </a>
                    <?php endif; ?>
                </div>
            <?php else: ?>
            <table class="asset-table" id="buildingsTable">
                <thead>
                    <tr>
                        <th data-sort="text">S/N</th>
                        <th data-sort="text">Asset Code</th>
                        <th data-sort="text">Building Name</th>
                        <th data-sort="text">Type</th>
                        <th data-sort="text">Location</th>
                        <th data-sort="number">Floor Count</th>
                ...
                <tbody>
                    ...
                    <tr data-type="<?php echo strtolower($asset['building_type'] ?? ''); ?>" 
                        ...
                        <td><?php echo Security::escape($asset['building_name'] ?? ''); ?></td>
                        <td>
                            <span class="badge badge-info"><?php echo Security::escape($asset['building_type'] ?? ''); ?></span>
                        </td>
                        <td>
                            <?php 
                            $location = [];
                        ...
                        <td class="text-right">
                            <?php 
                            if (!empty($asset['contract_sum'])) {
                                echo '₦' . number_format($asset['contract_sum'], 2);
                            } else {
                                echo '-';
                            }
                            ?>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="<?php echo BASE_URL; ?>/buildings/show/<?php echo $asset['id'] ?? ''; ?>" 
                                   class="btn-icon" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <?php if (Auth::can('building.edit')): ?>
                                <a href="<?php echo BASE_URL; ?>/buildings/edit/<?php echo $asset['id'] ?? ''; ?>" 
                                   class="btn-icon" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <?php endif; ?>
                                <?php if (Auth::can('building.delete')): ?>
                                <a href="<?php echo BASE_URL; ?>/buildings/delete/<?php echo $asset['id'] ?? ''; ?>" 
                                   class="btn-icon delete" title="Delete"
                                   onclick="return confirm('Are you sure you want to delete this building asset?')">
...
function applyFilters() {
    const searchTerm = document.getElementById('searchBuildings').value.trim();
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (urlParams.has('search')) document.getElementById('searchBuildings').value = urlParams.get('search');
    ...
    let searchTimeout;
    document.getElementById('searchBuildings').addEventListener('input', function() {
